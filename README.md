...
Your Machine
    ...
    ▼
AWS S3 (tf01)
    ├── static-site/terraform.tfstate  ← Remote state
    │
AWS DynamoDB (dynamotfdb)
    └── LockID record during apply     ← State lock

    ↓ Resources created ↓

AWS S3 (kailash-portfolio-2025)
    ...
    │
    ▼
http://kailash-portfolio-2025.s3-website-us-east-1.amazonaws.com
    │
    ▼
Anyone on the internet can view your portfolio
```
